...
<head>
    ...
    <title>Inventaris &mdash; Home</title>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li class="mb-2"><a class="nav-link text-primary" href="/user/home/index.php"><i
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="card mx-auto" style="width: 15rem;">
                                <img src="https://p-id.ipricegroup.com/uploaded_bba3424feafc2e8f9738c5e08453755d.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">BENQ U22</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
