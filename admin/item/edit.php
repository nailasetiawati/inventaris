...
<head>
    ...
    <title>Inventaris &mdash; Edit Barang</title>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Form Edit Barang</h2>
                        <p class="section-lead">
                            Berikut adalah form edit barang yang ada pada aplikasi inventaris!
                        </p>
                                    ...
                                    <div class="card-body">
                                        <form action="">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" name="name" id="name" class="form-control"
                                                            placeholder="Masukkan Nama Barang...." value="BENQ U22">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="category_id" class="form-control select2">
                                                            ...
                                                            <option value="1" selected>Proyektor</option>
                                                            <option value="2">Alat Tulis</option>
                                                            <option value="3">Kabel</option>
                                                            <option value="4">Alat Komputer</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                            ...
                                            <div class="float-right">
                                                <a href="/admin/item/index.php" class="btn btn-danger">Kembali</a>
