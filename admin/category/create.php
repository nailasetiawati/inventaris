...
<head>
    ...
    <title>Inventaris &mdash; Tambah Kategori</title>
                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <p class="section-lead">
                            Berikut adalah form tambah kategori yang ada pada aplikasi inventaris!
                        </p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="/admin/category/store.php" method="POST">
                                            <div class="form-group mb-3">
                                                <label for="name">Nama Kategori</label>
                                                <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Kategori Barang....">
                                                <?php
                                                    if(isset($_GET['pesan'])){
                                                        $pesan = $_GET['pesan'];
                                                        if($pesan == 'null_name'){
                                                            ...
                                                            echo '<p class="text-danger small"><b>Nama sudah digunakan!</b></p>';
                                                        }
                                                    }
                                                ?>
                                            </div>
