...
<head>
    ...
    <title>Inventaris &mdash; Edit Peminjaman</title>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Form Edit Peminjaman</h2>
                        <p class="section-lead">
                            Berikut adalah form edit peminjaman yang ada pada aplikasi inventaris!
                        </p>
                                        ...
                                        <form action="">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="user_id" class="form-control select2">
                                                            <option value="1" selected>202110065 | Agus Sampoerna</option>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="item_id" class="form-control select2">
                                                            <option value="1" selected>BRG - 001 | BENQ U22</option>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" name="borrow_date" id="borrowdate" class="form-control" value="2023-05-23">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-3">
                                                    <label for="estimate">Estimasi Dikembalikan</label>
                                                    <input type="date" name="estimated_return" id="estimate" class="form-control" value="2023-05-24">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-3">
                                                    <label for="return">Tanggal Dikembalikan</label>
                                                    <input type="date" name="returned_date" id="return" class="form-control" value="2023-05-23">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                    <div class="form-group mb-3">
                                                        <label for="selectItem">Kondisi Dikembalikan</label>
                                                        <select name="item_id" class="form-control select2">
