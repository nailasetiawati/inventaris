...
<head>
    ...
    <title>Inventaris &mdash; Tambah Kelas</title>
                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <p class="section-lead">
                            Berikut adalah form edit kelas yang ada pada aplikasi inventaris!
                        </p>
                                        ...
                                        <form action="/admin/class/update.php" method="POST">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control"
                                                    placeholder="Masukkan Nama Kelas...." value="<?php echo $data['class_name'] ?>">
                                            </div>
