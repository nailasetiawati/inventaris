...
<head>
    ...
    <title>Inventaris &mdash; Daftar Kelas</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="tbClass">
                                                <thead>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <a href="/admin/class/create.php"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $data['class_name'] ?></td>
